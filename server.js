...
var userroutes_v1 = require('./api/exercise.routes.v1');
var friendroutes = require('./api/friends.routes.v1');
var personalroutes = require('./api/personalScheme.routes.v1');
//var shoppingroutes_v1 = require('./api/shoppingList.routes.v1');
